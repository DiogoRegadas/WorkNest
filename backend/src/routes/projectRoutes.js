...
const {
  ...
  atualizarProjeto,
  apagarProjeto,
  obterProjetoCompleto,
  removerColaborador,
  transferirOwner,
  sairDoProjeto,             // ✅ novo
  transferirOwnerESair       // ✅ novo
...
// ✅ NOVAS ROTAS
router.post('/projetos/:idProjeto/sair', authMiddleware, sairDoProjeto);
router.post('/projetos/:idProjeto/transferir-e-sair', authMiddleware, transferirOwnerESair);
